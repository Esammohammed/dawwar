...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dawwar-realestate-platform-super-secret-key-2026')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Dawwar Real Estate API',
    'DESCRIPTION': 'API service for the Dawwar real estate platform',
    'VERSION': '1.0.0',
...
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', '').split(',') if os.environ.get('CSRF_TRUSTED_ORIGINS') else [
    ...
    'http://127.0.0.1:8000',
    'https://dawwar.app',
    'https://www.dawwar.app',
    'http://dawwar.app',
    'http://www.dawwar.app',
    'http://44.221.217.191',
    'https://44.221.217.191',
]
